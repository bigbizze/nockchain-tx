...
The hoon / nock virtual machine dependencies of the core implementation of wallets in nockchain prevented any easy way to create browser extension wallets, and complicated creating light APIs that languages like Python or Typescript could hook in to. This should be a step towards resolving those issues 
